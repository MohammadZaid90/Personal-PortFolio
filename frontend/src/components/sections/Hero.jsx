    ...
    >
      ...
      <div className="w-full max-w-3xl mx-auto text-center relative z-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full border mb-5 sm:mb-8"
          style={{
        ...
        {/* Name — key fix: clamp starts at 1.6rem so it never overflows even on 320px */}
        <motion.h1
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.45, delay: 0.08 }}
          className="font-head font-extrabold leading-[1.05] mb-3 w-full"
        ...
        <motion.p
          ...
          className="font-light mb-2 px-2"
          style={{ color: 'var(--text-secondary)', fontSize: 'clamp(0.8rem, 3.2vw, 1.3rem)' }}
        >
        ...
        <motion.div
          ...
          className="font-head font-semibold mb-5 sm:mb-8"
          style={{ fontSize: 'clamp(0.85rem, 3.2vw, 1.25rem)', color: '#a78bfa' }}
        >
          <TypeAnimation
            sequence={[
              'AI Engineer', 2000,
        ...
        <motion.p
          ...
          className="max-w-xl mx-auto leading-relaxed mb-7 sm:mb-10 px-2"
          style={{ color: 'var(--text-muted)', fontSize: 'clamp(0.8rem, 2.8vw, 1rem)' }}
        >
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center items-center mb-9 sm:mb-14 px-2"
        >
          <button
